                    ...
                    <div className="flex flex-col md:flex-row md:max-w-xl rounded-lg bg-white shadow-lg">
                        ...
                        <div className="p-6 flex flex-col justify-start">
                            <h5 className="text-gray-900 text-xl font-medium mb-2">{product.name}</h5>
                                ...
                                <p className="text-gray-700 text-base mb-4">
                                    Status: {product.status==="1"?"Available":"Sold"}
                                </p>
                                <div className='flex'>
                                    {product.status==="1" && <button type="button" className="m-2 inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase
